...
# Load data
with open('chunks_chromadb_chap7.json', 'r') as f:
    data = json.load(f)

# Delete old collection if exists
try:
    client.delete_collection("samm_chapter7")
except:
    pass

# Create collection
collection = client.create_collection("samm_chapter7")
...
# Test query
print(f"\n🔍 Test query:")
results = collection.get(where={"section_id": "C7.1.1"})
