...
# Load data
with open('chunks_chromadb_chap9.json', 'r') as f:
    data = json.load(f)

# Delete old collection if exists
try:
    client.delete_collection("samm_chapter9")
except:
    pass

# Create collection
collection = client.create_collection("samm_chapter9")
...
# Test query
print(f"\n🔍 Test query:")
results = collection.get(where={"section_id": "C9.1.1"})
