...
# Load data
with open('chunks_chromadb_chap4_updated.json', 'r') as f:
    data = json.load(f)

# Delete old collection if exists
try:
    client.delete_collection("samm_chapter4")
except:
    pass

# Create collection
collection = client.create_collection("samm_chapter4")
...
# Test query
print(f"\n🔍 Test query:")
results = collection.get(where={"section_id": "C4.1.1"})
