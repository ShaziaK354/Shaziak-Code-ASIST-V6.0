...
# Load data
with open('chunks_chromadb_chap5_updated.json', 'r') as f:
    data = json.load(f)

# Delete old collection if exists
try:
    client.delete_collection("samm_chapter5")
except:
    pass

# Create collection
collection = client.create_collection("samm_chapter5")
...
# Test query
print(f"\n🔍 Test query:")
results = collection.get(where={"section_id": "C5.1.1"})
